...
public isolated client class Client {
    ...
    resource isolated function get programmes/review(map<string|string[]> headers = {}) returns Programme[]|error {
    ...
    resource isolated function post programmes(Programme payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/programmes`;
    ...
    resource isolated function put programmes/[string programmeCode](Programme payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/programmes/${getEncodedUri(programmeCode)}`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
